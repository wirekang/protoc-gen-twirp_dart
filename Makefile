...
install:
	go install ${LDFLAGS} github.com/wirekang/protoc-gen-twirp_dart
...
build_linux:
	GOOS=linux GOARCH=amd64 go build -o ${BINARY} ${LDFLAGS} github.com/wirekang/protoc-gen-twirp_dart
